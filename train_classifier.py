...
class StartingVerbExtractor(BaseEstimator, TransformerMixin):
    ...
    Gets starting verb of each sentence.
    Used as a feature for the classifier model
    """
...
def build_model():
    """
    Building ML pipeline using Starting verb extractor class 
    and best parameters (min samples split 2, estimators 20),  as found via gridsearch in the ML pipeline preparation notebook 
    """
